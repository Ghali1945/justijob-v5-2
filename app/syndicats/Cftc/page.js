...
export default function CFTCDashboard() {
  ...
  const syndicatInfo = {
    name: 'CFTC',
    fullName: 'Confederation Francaise des Travailleurs Chretiens',
  ...
  const recentActivities = [
    { id: 1, type: 'Nouveau dossier', user: 'Francois Durand', time: 'Il y a 3h', status: 'En cours' },
    { id: 2, type: 'Paiement recu', user: 'Catherine Leroux', time: 'Il y a 5h', status: 'Valide' },
    { id: 3, type: 'Dossier complete', user: 'Michel Dupuis', time: 'Il y a 7h', status: 'Termine' },
    { id: 4, type: 'Nouveau membre', user: 'Veronique Bonnet', time: 'Il y a 9h', status: 'Actif' }
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div key={activity.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
                        <span className="text-purple-600 font-bold text-sm">{activity.user.charAt(0)}</span>
                      </div>
                      <div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="p-6 space-y-3">
              ...
              <button className="w-full px-4 py-3 bg-white border-2 border-purple-600 text-purple-600 rounded-lg hover:bg-purple-50 transition-colors text-sm font-medium">
                Gerer les membres
              </button>
            ...
            <div className="p-6 border-t border-gray-200">
              <div className="bg-purple-50 rounded-lg p-4">
                <p className="text-sm font-medium text-purple-900 mb-2">Astuce du jour</p>
