...
export default function CFTCDashboard() {
  ...
  const recentActivities = [
    { id: 1, user: 'Laurent C.', action: 'Nouveau membre', time: 'Il y a 4h' },
    { id: 2, user: 'Martine F.', action: 'Dossier cree', time: 'Il y a 6h' },
    { id: 3, user: 'Bernard H.', action: 'Diagnostic complete', time: 'Il y a 9h' },
    { id: 4, user: 'Valerie N.', action: 'Documents generes', time: 'Il y a 1j' },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              <button className="w-full bg-purple-600 text-white py-3 px-4 rounded-lg hover:bg-purple-700 transition-colors font-semibold text-left flex items-center gap-3">
                <span>👥</span>
                Gerer les membres
              </button>
