...
export default function UNSADashboard() {
  ...
  const recentActivities = [
    { id: 1, type: 'Nouveau dossier', user: 'Sophie Martin', time: 'Il y a 2h', status: 'En cours' },
    { id: 2, type: 'Paiement recu', user: 'Thomas Dubois', time: 'Il y a 4h', status: 'Valide' },
    { id: 3, type: 'Dossier complete', user: 'Marie Leroy', time: 'Il y a 6h', status: 'Termine' },
    { id: 4, type: 'Nouveau membre', user: 'Pierre Bernard', time: 'Il y a 8h', status: 'Actif' }
  ]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div key={activity.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center">
                        <span className="text-red-600 font-bold text-sm">{activity.user.charAt(0)}</span>
                      </div>
                      <div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="p-6 space-y-3">
              ...
              <button className="w-full px-4 py-3 bg-white border-2 border-red-600 text-red-600 rounded-lg hover:bg-red-50 transition-colors text-sm font-medium">
                Gerer les membres
              </button>
            ...
            <div className="p-6 border-t border-gray-200">
              <div className="bg-red-50 rounded-lg p-4">
                <p className="text-sm font-medium text-red-900 mb-2">Astuce du jour</p>
