...
export default function CGTDashboard() {
  ...
  const recentActivities = [
    { id: 1, type: 'Nouveau dossier', user: 'Jean Dupont', time: 'Il y a 2h', status: 'En cours' },
    { id: 2, type: 'Paiement recu', user: 'Marie Martin', time: 'Il y a 4h', status: 'Valide' },
    { id: 3, type: 'Dossier complete', user: 'Pierre Bernard', time: 'Il y a 6h', status: 'Termine' },
    { id: 4, type: 'Nouveau membre', user: 'Sophie Dubois', time: 'Il y a 8h', status: 'Actif' }
  ]
