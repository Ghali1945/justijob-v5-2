...
export default function CFDTDashboard() {
  ...
  const syndicatInfo = {
    name: 'CFDT',
    fullName: 'Confederation Francaise Democratique du Travail',
  ...
  const recentActivities = [
    { id: 1, type: 'Nouveau dossier', user: 'Claire Fontaine', time: 'Il y a 3h', status: 'En cours' },
    { id: 2, type: 'Paiement recu', user: 'Marc Lefevre', time: 'Il y a 5h', status: 'Valide' },
    { id: 3, type: 'Dossier complete', user: 'Anne Petit', time: 'Il y a 7h', status: 'Termine' },
    { id: 4, type: 'Nouveau membre', user: 'Luc Moreau', time: 'Il y a 9h', status: 'Actif' }
  ]
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            ...
            <p className="text-xs text-green-600 mt-2">+10% ce mois</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="p-6 space-y-3">
              ...
              <button className="w-full px-4 py-3 bg-white border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors text-sm font-medium">
                Gerer les membres
              </button>
            ...
            <div className="p-6 border-t border-gray-200">
              <div className="bg-blue-50 rounded-lg p-4">
                <p className="text-sm font-medium text-blue-900 mb-2">Astuce du jour</p>
