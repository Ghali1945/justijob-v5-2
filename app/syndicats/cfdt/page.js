...
export default function CFDTDashboard() {
  ...
  const recentActivities = [
    { id: 1, user: 'Sophie M.', action: 'Nouveau membre', time: 'Il y a 1h' },
    { id: 2, user: 'Thomas B.', action: 'Dossier cree', time: 'Il y a 3h' },
    { id: 3, user: 'Claire D.', action: 'Diagnostic complete', time: 'Il y a 6h' },
    { id: 4, user: 'Lucas P.', action: 'Documents generes', time: 'Il y a 1j' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-green-600 text-sm font-semibold">+10%</span>
            </div>
            <h3 className="text-3xl font-bold text-gray-800 mb-1">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-blue-600 text-sm font-semibold">+18%</span>
            </div>
            <h3 className="text-3xl font-bold text-gray-800 mb-1">
