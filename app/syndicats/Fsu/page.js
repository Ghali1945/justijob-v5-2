...
export default function FSUDashboard() {
  ...
  const syndicatInfo = {
    name: 'FSU',
    fullName: 'Federation Syndicale Unitaire',
  ...
  const recentActivities = [
    { id: 1, type: 'Nouveau dossier', user: 'Laurent Mercier', time: 'Il y a 1h', status: 'En cours' },
    { id: 2, type: 'Paiement recu', user: 'Isabelle Rousseau', time: 'Il y a 3h', status: 'Valide' },
    { id: 3, type: 'Dossier complete', user: 'Nicolas Blanc', time: 'Il y a 5h', status: 'Termine' },
    { id: 4, type: 'Nouveau membre', user: 'Camille Girard', time: 'Il y a 7h', status: 'Actif' }
  ]
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 bg-yellow-100 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            ...
            <p className="text-xs text-green-600 mt-2">+11% vs mois dernier</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div key={activity.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-yellow-100 rounded-full flex items-center justify-center">
                        <span className="text-yellow-600 font-bold text-sm">{activity.user.charAt(0)}</span>
                      </div>
                      <div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="p-6 space-y-3">
              <button className="w-full px-4 py-3 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition-colors text-sm font-medium">
                Voir tous les dossiers
              </button>
              <button className="w-full px-4 py-3 bg-white border-2 border-yellow-600 text-yellow-600 rounded-lg hover:bg-yellow-50 transition-colors text-sm font-medium">
                Gerer les membres
              </button>
            ...
            <div className="p-6 border-t border-gray-200">
              <div className="bg-yellow-50 rounded-lg p-4">
                <p className="text-sm font-medium text-yellow-900 mb-2">Astuce du jour</p>
