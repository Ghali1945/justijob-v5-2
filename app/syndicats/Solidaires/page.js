...
export default function SolidairesDashboard() {
  ...
  const recentActivities = [
    { id: 1, type: 'Nouveau dossier', user: 'Valerie Moreau', time: 'Il y a 2h', status: 'En cours' },
    { id: 2, type: 'Paiement recu', user: 'Antoine Simon', time: 'Il y a 4h', status: 'Valide' },
    { id: 3, type: 'Dossier complete', user: 'Julie Laurent', time: 'Il y a 6h', status: 'Termine' },
    { id: 4, type: 'Nouveau membre', user: 'Maxime Lefebvre', time: 'Il y a 9h', status: 'Actif' }
  ]
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            ...
            <p className="text-xs text-green-600 mt-2">+7% vs mois dernier</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div key={activity.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center">
                        <span className="text-gray-700 font-bold text-sm">{activity.user.charAt(0)}</span>
                      </div>
                      <div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="p-6 space-y-3">
              <button className="w-full px-4 py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-800 transition-colors text-sm font-medium">
                Voir tous les dossiers
              </button>
              <button className="w-full px-4 py-3 bg-white border-2 border-gray-700 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium">
                Gerer les membres
              </button>
            ...
            <div className="p-6 border-t border-gray-200">
              <div className="bg-gray-100 rounded-lg p-4">
                <p className="text-sm font-medium text-gray-900 mb-2">Astuce du jour</p>
