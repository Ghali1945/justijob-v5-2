...
export default function CFECGCDashboard() {
  ...
  const recentActivities = [
    { id: 1, user: 'Philippe D.', action: 'Nouveau membre', time: 'Il y a 3h' },
    { id: 2, user: 'Nathalie V.', action: 'Dossier cree', time: 'Il y a 5h' },
    { id: 3, user: 'Olivier M.', action: 'Diagnostic complete', time: 'Il y a 7h' },
    { id: 4, user: 'Sylvie B.', action: 'Documents generes', time: 'Il y a 1j' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-green-600 text-sm font-semibold">+9%</span>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-green-600 text-sm font-semibold">+6%</span>
            </div>
            <h3 className="text-3xl font-bold text-gray-800 mb-1">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-blue-600 text-sm font-semibold">+11%</span>
            </div>
            <h3 className="text-3xl font-bold text-gray-800 mb-1">
