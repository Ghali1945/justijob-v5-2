...
export default function CFECGCDashboard() {
  ...
  const syndicatInfo = {
    name: 'CFE-CGC',
    fullName: 'Confederation Francaise de l\'Encadrement - CGC',
  ...
  const recentActivities = [
    { id: 1, type: 'Nouveau dossier', user: 'Olivier Blanc', time: 'Il y a 2h', status: 'En cours' },
    { id: 2, type: 'Paiement recu', user: 'Nathalie Roux', time: 'Il y a 4h', status: 'Valide' },
    { id: 3, type: 'Dossier complete', user: 'Eric Garnier', time: 'Il y a 6h', status: 'Termine' },
    { id: 4, type: 'Nouveau membre', user: 'Sylvie Marchand', time: 'Il y a 8h', status: 'Actif' }
  ]
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            ...
            <p className="text-xs text-green-600 mt-2">+11% ce mois</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            ...
            <p className="text-xs text-green-600 mt-2">+9% vs mois dernier</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div key={activity.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center">
                        <span className="text-green-600 font-bold text-sm">{activity.user.charAt(0)}</span>
                      </div>
                      <div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="p-6 space-y-3">
              ...
              <button className="w-full px-4 py-3 bg-white border-2 border-green-600 text-green-600 rounded-lg hover:bg-green-50 transition-colors text-sm font-medium">
                Gerer les membres
              </button>
            ...
            <div className="p-6 border-t border-gray-200">
              <div className="bg-green-50 rounded-lg p-4">
                <p className="text-sm font-medium text-green-900 mb-2">Astuce du jour</p>
